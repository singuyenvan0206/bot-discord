    ...
    async execute(message, args) {
        ...
        const embed = new EmbedBuilder()
            ...
            .addFields(
                ...
                { name: t('ping.servers', lang), value: `\`${message.client.guilds.cache.size.toLocaleString()}\``, inline: true },
                { name: t('ping.users', lang), value: `\`${message.client.users.cache.size.toLocaleString()}\``, inline: true },

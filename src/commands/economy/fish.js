...
const CATCHES = [
    ...
    { key: 'pufferfish', emoji: '🐡', value: 2500, weight: 95, minLuck: 6.0 },
    { key: 'clownfish', emoji: '🐠', value: 4000, weight: 90, minLuck: 8.0 },
    { key: 'stingray', emoji: '🐡', value: 7500, weight: 80, minLuck: 10.0 },
    { key: 'tuna', emoji: '🐟', value: 12000, weight: 65, minLuck: 12.0 },
    { key: 'swordfish', emoji: '🗡️', value: 18000, weight: 60, minLuck: 15.0 },
    { key: 'manta_ray', emoji: '🐋', value: 25000, weight: 55, minLuck: 18.0 },
    { key: 'shark', emoji: '🦈', value: 20000, weight: 50, minLuck: 20.0 },
    { key: 'whale', emoji: '🐋', value: 40000, weight: 45, minLuck: 22.0 },
    { key: 'anglerfish', emoji: '🏮', value: 60000, weight: 40, minLuck: 25.0 },
    { key: 'treasure_chest', emoji: '💰', value: 100000, weight: 35, minLuck: 28.0 },
    { key: 'mythical_pearl', emoji: '🔮', value: 150000, weight: 50, minLuck: 32.0 },
    { key: 'kraken', emoji: '🐙', value: 300000, weight: 45, minLuck: 35.0 },
    { key: 'megalodon', emoji: '🦈', value: 750000, weight: 40, minLuck: 38.0 },
    { key: 'poseidon_trident', emoji: '🔱', value: 1500000, weight: 30, minLuck: 42.0 }
];

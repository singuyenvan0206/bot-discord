...
const EMOJI_QUIZ = [
    ...
    { emojis: '🦇👨🏙️🌃👊', answers: ['batman'], category: '🎬 Movie' },
    { emojis: '🕸️🕷️👨🏙️🤟', answers: ['spiderman', 'spider-man', 'spider man'], category: '🎬 Movie' },
    ...
    { emojis: '🍎👸🏰🧙‍♀️🍄', answers: ['snow white'], category: '🎬 Movie' },
    { emojis: '🧞‍♂️✨🐒🕌👳', answers: ['aladdin'], category: '🎬 Movie' },
    { emojis: '🚀🌌⚔️🤖👽', answers: ['star wars'], category: '🎬 Movie' },
    { emojis: '💍🌋👣🧟‍♂️🏹', answers: ['lord of the rings', 'lotr'], category: '🎬 Movie' },
    { emojis: '🏴‍☠️🦜🚢💀⚔️', answers: ['pirates of the caribbean'], category: '🎬 Movie' },
    ...
    { emojis: '🍊⬛🏢👯‍♀️🔐', answers: ['orange is the new black'], category: '📺 TV Show' },
    ...
    // ═══ Songs / Music ═══
    { emojis: '🎵👶👶👶👱‍♀️🎳', answers: ['baby', 'baby by justin bieber'], category: '🎵 Song' },
    { emojis: '🌧️☔😢💧🚗', answers: ['umbrella', 'singing in the rain'], category: '🎵 Song' },
    { emojis: '🎤👸💍💃✋', answers: ['single ladies'], category: '🎵 Song' },
    { emojis: '🌈🌧️👋👠🌪️', answers: ['somewhere over the rainbow', 'over the rainbow'], category: '🎵 Song' },
    { emojis: '🎸🤘😈🔥🛣️', answers: ['highway to hell'], category: '🎵 Song' },
    ...
    { emojis: '🦋✨🎶🌪️🏰', answers: ['butterfly', 'wings'], category: '🎵 Song' },
    { emojis: '🌊🏄‍♂️☀️🏄‍♀️🏖️', answers: ['surfin usa', 'ocean eyes'], category: '🎵 Song' },
    ...
    { emojis: '🧁🎂🎉🕯️🍰', answers: ['birthday cake', 'cake', 'cupcake'], category: '🍽️ Food' },
    ...
    { emojis: '🐢🌊🐚🏖️🐢', answers: ['sea turtle', 'turtle'], category: '🐾 Animal' },
    ...
    { emojis: '🏀🏆🇺🇸⛹️‍♂️👟', answers: ['nba', 'basketball'], category: '⚽ Sport' },
    { emojis: '🎾🏟️🍓🥛🇬🇧', answers: ['wimbledon', 'tennis'], category: '⚽ Sport' },
    { emojis: '🏈🏆🍗🏟️🎆', answers: ['super bowl', 'football', 'nfl'], category: '⚽ Sport' },
    { emojis: '🏊‍♂️🚴‍♂️🏃‍♂️🏅⏱️', answers: ['triathlon'], category: '⚽ Sport' },
    { emojis: '🥊🔔💪🦷🩸', answers: ['boxing'], category: '⚽ Sport' },
    { emojis: '⛷️🏔️❄️🎿🚠', answers: ['skiing'], category: '⚽ Sport' },
    { emojis: '🏒🥅🧊🧤❄️', answers: ['ice hockey', 'hockey'], category: '⚽ Sport' },
    ...
    // ═══ More Movies ═══
    { emojis: '🦸‍♂️🛡️⭐🇺🇸🏋️‍♂️', answers: ['captain america'], category: '🎬 Movie' },
    ...
    { emojis: '🗽🇺🇸🏝️🏙️🎆', answers: ['statue of liberty'], category: '🏛️ Landmark' },
    { emojis: '🏯🌸🇯🇵🏯🍵', answers: ['japanese castle', 'temple', 'kyoto'], category: '🏛️ Landmark' },
    { emojis: '🧱🐉🇨🇳🏔️🏰', answers: ['great wall of china', 'great wall'], category: '🏛️ Landmark' },
    ...
    { emojis: '🎡🇬🇧🌉🕰️🚌', answers: ['london eye', 'big ben', 'tower bridge'], category: '🏛️ Landmark' },
    { emojis: '🏔️🧊🇳🇵🐂🏕️', answers: ['mount everest', 'everest'], category: '🏛️ Landmark' },
    { emojis: '🌋🏝️🌊🌺🍍', answers: ['hawaii', 'volcano', 'mount fuji'], category: '🏛️ Landmark' },
    { emojis: '🎰🌃💰🎲🃏', answers: ['las vegas', 'vegas'], category: '🏛️ Landmark' },
    { emojis: '🏟️⚔️🇮🇹🛡️🦁', answers: ['colosseum', 'coliseum'], category: '🏛️ Landmark' },

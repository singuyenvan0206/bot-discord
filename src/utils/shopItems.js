module.exports = [
    ...
    { id: 107, name: 'Moai Statue', price: 10000, multiplier: 0.25, duration: 2592000, type: 'daily' },
    { id: 108, name: 'VIP Golden Ticket', price: 50000, multiplier: 0.75, duration: 2592000, type: 'daily' },
    { id: 109, name: 'Mansion', price: 250000, multiplier: 1.50, duration: 2592000, type: 'daily', idealJob: 'streamer' },
    { id: 110, name: 'Space Station', price: 500000, multiplier: 3.50, duration: 2592000, type: 'daily', idealJob: 'hacker' },

    // ==========================================
    // GROUP 200 — income (buff $work, $fish, $search)
    // ==========================================
    { id: 201, name: 'Smartphone', price: 1000, multiplier: 0.08, duration: 604800, type: 'income' },
    { id: 202, name: 'Shield', price: 1000, multiplier: 0.05, duration: 604800, type: 'income', idealJob: 'police' },
    { id: 203, name: 'Knight Sword', price: 1500, multiplier: 0.12, duration: 604800, type: 'income', idealJob: 'police' },
    { id: 204, name: 'Sneakers', price: 2000, multiplier: 0.10, duration: 604800, type: 'income', idealJob: 'criminal' },
    { id: 205, name: 'Pickaxe', price: 2500, multiplier: 0.12, duration: 604800, type: 'income', idealJob: 'farmer' },
    { id: 206, name: 'RGB Keyboard', price: 2500, multiplier: 0.08, duration: 604800, type: 'income', idealJob: 'programmer' },
    { id: 207, name: 'Gaming Mouse', price: 2500, multiplier: 0.08, duration: 604800, type: 'income', idealJob: 'programmer' },
    ...
    { id: 212, name: 'Laptop', price: 5000, multiplier: 0.20, duration: 2592000, type: 'income', idealJob: 'hacker' },
    { id: 213, name: 'Standing Desk', price: 6000, multiplier: 0.18, duration: 2592000, type: 'income', idealJob: 'programmer' },
    { id: 214, name: 'Trading Terminal', price: 8000, multiplier: 0.25, duration: 2592000, type: 'income', idealJob: 'trader' },
    { id: 215, name: 'Ergonomic Chair', price: 8000, multiplier: 0.25, duration: 2592000, type: 'income', idealJob: 'streamer' },
    { id: 216, name: 'Business Suit', price: 10000, multiplier: 0.30, duration: 2592000, type: 'income', idealJob: 'doctor' },
    { id: 217, name: 'Combat Armor', price: 15000, multiplier: 0.30, duration: 2592000, type: 'income', idealJob: 'soldier' },
    { id: 218, name: 'Grand Piano', price: 20000, multiplier: 0.40, duration: 2592000, type: 'income', idealJob: 'musician' },
    { id: 219, name: 'Supercar', price: 50000, multiplier: 0.60, duration: 2592000, type: 'income', idealJob: 'criminal' },
    { id: 220, name: 'Superyacht', price: 100000, multiplier: 2.00, duration: 2592000, type: 'income', idealJob: 'hacker' },
    ...
    { id: 310, name: 'Time Machine', price: 1000000, multiplier: 6.00, duration: 2592000, type: 'gamble' },
